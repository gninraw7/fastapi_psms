...
DROP TABLE IF EXISTS `auth_forms`;
...
DROP TABLE IF EXISTS `board_notices`;
...
DROP TABLE IF EXISTS `industry_fields`;
...
DROP TABLE IF EXISTS `sales_actual_line`;
...
DROP TABLE IF EXISTS `sales_plan_line`;
...
DROP TABLE IF EXISTS `tbl_file_storage`;
...
DROP TABLE IF EXISTS `tmp_invalid_project_manager_id`;
...
-- Dumping events for database 'psms'

-- Dumping routines for database 'psms'


-- Dump completed on 2026-02-07  9:09:41
